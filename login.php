            ...
            <?php
				...
				if(isset($_POST["btnlogin"])){
					...
					if(mysql_num_rows($hasil) > 0){
						...
						$_SESSION['pengusaha_username'] 	= $r['username'];
						$_SESSION['pengusaha_password']	= $r['password'];
						$_SESSION['pengusaha_id'] 			= $r['id_user'];
						$_SESSION['pengusaha_level'] 		= $r['level'];
              ...
              <form role="form" name="forminput" method="post" enctype="multipart/form-data">
                  ...
                  <div>
                    <select name="inputLevel" autofocus required class="form-control">
                      ...
                      <option value="3">Karyawan [Managemen]</option>
                    </select>
                  </div>
                  <br>
                  ...
                  <div class="pull-left">
                    <h4><a href="aplikasi/?page=home"><i class="fa fa-arrow-left"></i> Kembali</a></h4>
                  </div>
			  </form>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> PENGUSAHA MUDA!</h1>
