	...
	<hr class="soft"/>
		<table class="table table-bordered">
          ...
          <tbody>
            ...
            <?php }
				$sqlcekorder 	= "SELECT * FROM orders JOIN orders_items ON orders.id_order = orders_items.id_order WHERE orders.id_member='".$_SESSION['pengusaha_id']."' AND orders.id_order='".$_GET['order']."'";
