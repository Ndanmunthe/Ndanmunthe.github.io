<?php
$sql 	= "SELECT * FROM pembeli WHERE id_pembeli = '".$_SESSION['pengusaha_id']."'";
...
if ($foto == ""){
$foto 	= "foto_pembeli/unavailable.jpg";
}else{
$foto 	= "foto_pembeli/".$d['foto_pembeli'];
}
...
<div class="row">	  
    <div class="span9">
        <table class="table table-striped table-bordered">
          ...
          <tbody>
          <?php
                $sql2	= "SELECT * FROM orders WHERE id_pembeli = '$id_pembeli' AND status !='1' ORDER BY id_order DESC LIMIT 0,25";
