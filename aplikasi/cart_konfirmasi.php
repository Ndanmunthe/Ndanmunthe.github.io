    ...
    <div class="span6">
     ...
     if(isset($_POST['submit'])){
        ...
        $sql2	= "UPDATE orders SET id_transfer='$idtransf', tgl_bayar=NOW(), status='3' WHERE id_pembeli='".$_SESSION['pengusaha_id']."' AND id_order='$orderid'";
     ...
     <div class="control-group">
       ...
       <div class="controls">
         <select autofocus required name="inputorderid" class="controls-row">
           <option value="">Pilih </option>
           <?php 
            $sqltransaksi 	= "SELECT * FROM orders WHERE id_pembeli='".$_SESSION['pengusaha_id']."' AND status ='2' AND tipe_pembayaran !='cod'";
