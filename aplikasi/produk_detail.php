...
<?php
  ...
  if(isset($_POST['btnInput'])){
	 if(empty($_SESSION['pengusaha_username'])){
		 ...
		 if ($j_stok < $j_order){
			...
			$idpembeli = $_SESSION['pengusaha_id'];
			$jinput   = $j_order;
			$cekharga = mysql_fetch_array(mysql_query("SELECT harga FROM produk WHERE id_produk ='".$_GET['id']."'"));
			$hargadb  = $cekharga['harga'];
			$tot = $j_order * $hargadb;
			
			$sqlcekorder 	= "SELECT * FROM orders JOIN orders_items ON orders.id_order = orders_items.id_order WHERE orders.id_pembeli='".$idpembeli."' AND orders.status='1'";
			...
			if ($j == 0){
				...
				$proses  = mysql_query("INSERT INTO orders VALUES (
									'$kode', '".$_SESSION['pengusaha_id']."', '0', '0', '0',
				...
				$sql3 	= "SELECT id_order FROM orders WHERE id_pembeli ='".$idmember."' && status='1'";
				...
				if($jd4 == 0){
					$sql7 = mysql_query("UPDATE orders SET total='".$gtot."' WHERE id_order = '".$id_orderss."' && status ='1'");
...
<div class="row">	  
        ...
        <div id="myTabContent" class="tab-content">
          ...
          <h4>Informasi Produk</h4>
            ...
            <tr class="techSpecRow">
              <td class="techSpecTD1" width="20%">Network </td>
              <td class="techSpecTD2"><?php echo $data['network']?></td></tr>
            <tr class="techSpecRow">
              <td class="techSpecTD1">Launch</td>
              <td class="techSpecTD2"><?php echo $data['launch']?></td></tr>
            <tr class="techSpecRow">
              <td class="techSpecTD1">Body</td>
              <td class="techSpecTD2"><?php echo $data['body']?></td></tr>
			<tr class="techSpecRow">
              <td class="techSpecTD1" width="20%">Display </td>
              <td class="techSpecTD2"><?php echo $data['display']?></td></tr>
            <tr class="techSpecRow">
              <td class="techSpecTD1">Platform</td>
              <td class="techSpecTD2"><?php echo $data['platform']?> Inc.</td></tr>
            <tr class="techSpecRow">
              <td class="techSpecTD1">Memory</td>
              <td class="techSpecTD2"><?php echo $data['memory']?></td></tr>
			<tr class="techSpecRow">
              <td class="techSpecTD1" width="20%">Camera </td>
              <td class="techSpecTD2"><?php echo $data['sound']?></td></tr>
            <tr class="techSpecRow">
              <td class="techSpecTD1">Comms</td>
              <td class="techSpecTD2"><?php echo $data['comms']?> Inc.</td></tr>
            <tr class="techSpecRow">
              <td class="techSpecTD1">Features</td>
              <td class="techSpecTD2"><?php echo $data['features']?></td></tr>
  			<tr class="techSpecRow">
              <td class="techSpecTD1" width="20%">Battery </td>
              <td class="techSpecTD2"><?php echo $data['battery']?></td></tr>
            <tr class="techSpecRow">
              <td class="techSpecTD1">Misc</td>
              <td class="techSpecTD2"><?php echo $data['misc']?> Inc.</td></tr>
            <tr class="techSpecRow">
              <td class="techSpecTD1">Tests</td>
              <td class="techSpecTD2"><?php echo $data['tests']?></td></tr>
            </body>
            </table>
          </div>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="blockView">
            <ul class="thumbnails">
			<?php
				$sql   = "SELECT * FROM produk WHERE id_produk != '".$_GET['id']."' ORDER BY id_produk DESC";
				$query = mysql_query($sql);
