	...
	$cek = mysql_num_rows($query);
		if ($cek > 0){
			...
			if (trim($pass) != trim($pass2)){
				...
				$addsql = "INSERT INTO pembeli(id_pembeli, nama_pembeli, no_telp, alamat, kota, pos, email, foto_pembeli, tgl_daftar)
							VALUES
							('" . $id . "',
							 '" . strip_tags(addslashes($nama_pembeli)) . "',
				...
				if ($sukses && $sukses2){
					...
					<strong>Berhasil Mendaftar</strong>.
						...
						$_SESSION['pengusaha_username'] 	= $username;
						$_SESSION['pengusaha_password']	= md5($pass);
						$_SESSION['pengusaha_id'] 			= $id;
						$_SESSION['pengusaha_level'] 		= '2';
