...
<?php }else if(!empty($_SESSION['pengusaha_username'])){ 

$SQL_order = mysql_query("SELECT id_order FROM orders WHERE id_pembeli ='".$_SESSION['pengusaha_id']."' && status = '1'");
...
<div id="welcomeLine" class="row-fluid">
  <span class="pull-left">Selamat Datang! <b><a href="?page=profil"><?php echo $_SESSION['pengusaha_username'] ?></a></b></span>
