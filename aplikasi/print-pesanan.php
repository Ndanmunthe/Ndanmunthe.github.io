...
-->
	<?php 
	 ...
	 include_once "../lib/fungsi.php";
	  ...
	  $again = mysql_query("SELECT * FROM pembeli WHERE id_pembeli = '".$_SESSION['pengusaha_id']."'");
          ...
          <div class="span12">
            ...
            <thead>
                ...
                <tr>
                  ...
                  <th align="left"><?php echo $dagain['nama_pembeli']?></th>
                </tr>
                <tr>
            ...
            <table width="80%" border="1" align="center">
              ...
              ?>
                ...
                $sql3	= "SELECT * FROM orders WHERE id_pembeli= '".$_SESSION['pengusaha_id']."' AND id_order='".$_GET['order']."'";
