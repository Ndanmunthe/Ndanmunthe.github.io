				  ...
				  <form name="forminput" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                    <div class="col-md-5 col-sm-5 col-xs-12">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="inputUsername">Username
                        </label>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-12">
                          <select name="inputLevel" autofocus required class="form-control col-md-7 col-xs-12" id="inputLevel" title="Posisi">
                            ...
                            <option value="3" <?php echo $sel3?>> Karyawan [Managemen]</option>
                          </select>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea name="inputAlamat" type="text" class="form-control col-md-7 col-xs-12" id="inputAlamat" placeholder="Alamat" title="Alamat" rows="3"><?php echo $alamat?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
