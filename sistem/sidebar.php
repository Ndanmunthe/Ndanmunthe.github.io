...
$j_mbr = mysql_num_rows(mysql_query("SELECT id_pembeli FROM pembeli"));
$j_prd = mysql_num_rows(mysql_query("SELECT id_produk FROM produk"));

$sql_order_admin2 = "SELECT * FROM orders JOIN
					 pembeli ON orders.id_pembeli = pembeli.id_pembeli
...
$sql_order_admin = "SELECT *, count(id_produk) AS Jitem FROM orders JOIN orders_items ON
					 ...
					 orders.id_pembeli= pembeli.id_pembeli WHERE orders.validasi != 'yes' ORDER BY orders.tgl_order DESC";
...
<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
      <a href="?page=home" class="site_title"><i class="fa fa-home"></i> <span>PENGUSAHA MUDA</span></a>
    </div>
	<div class="clearfix"></div>
    <!-- sidebar menu -->
    <?php if($_SESSION['pengusaha_level'] == '1'){ ?>
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        <ul class="nav side-menu">
          <li><a href="../aplikasi/?page=home" target="_blank"><i class="fa fa-laptop"></i> Lihat Web</a></li>
          <li><a href="?page=karyawan"><i class="fa fa-briefcase"></i> Karyawan<span class="pull-right badge bg-blue"><?php echo $j_kry?></span></a></li>
          <li><a href="?page=pembeli"><i class="fa fa-sitemap"></i> Pembeli<span class="pull-right badge bg-green"><?php echo $j_mbr?></span></a></li>
          <!-- <li><a href="?page=produk"><i class="fa fa-puzzle-piece"></i> Produk</a></li>-->
          
          <li><a href="?page=produk"><i class="fa fa-puzzle-piece"></i>Produk</a>
    ...
    <?php if($_SESSION['pengusaha_level'] == '3'){ ?>
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        <ul class="nav side-menu">
          <li><a href="?page=karyawan"><i class="fa fa-briefcase"></i> Karyawan<span class="pull-right badge bg-blue"><?php echo $j_kry?></span></a></li>
          <li><a href="?page=member"><i class="fa fa-sitemap"></i> Pembeli<span class="pull-right badge bg-green"><?php echo $j_mbr?></span></a></li>
