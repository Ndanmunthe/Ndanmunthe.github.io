        ...
        <div class="row">
          <div class="col-xs-12">
			  <?php
                ...
                $sql2	= "SELECT * FROM orders JOIN pembeli ON 
                                    orders.id_pembeli = pembeli.id_pembeli
                                    WHERE orders.id_order='".$cariorder."'";
                $query2	= mysql_query($sql2);
                $d2 	= mysql_fetch_array($query2);
                $idmember 	= $d2['id_order'];
                $namapembeli	= $d2['nama_pembeli'];
               ...
               <table border="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <img width="200" src="../aplikasi/themes/images/logo.png"><br>
                      Kota Padang, Sumatera Barat 12345<br>
                      (0751) 32906
                      </th>
                    ...
                    <tr>
                      <th width="11%">Yth. </th>
                      <th width="37%">: <?php echo $namapembeli?></th>
                    </tr>
                    <tr>
