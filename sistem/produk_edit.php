            ...
            $features	 = $_POST['inputfeatures'];
						...
						if ($cekuname > 0){
							...
							$addsql = "UPDATE produk SET 
								...
								network= '".strip_tags(addslashes($network))."',
								launch	= '".strip_tags(addslashes($launch))."',
								body = '".strip_tags(addslashes($body))."',
								display = '".strip_tags(addslashes($display))."',
								platform	= '".strip_tags(addslashes($platform))."',
                memory = '".strip_tags(addslashes($memory))."',
								camera = '".strip_tags(addslashes($camera))."',
								sound	= '".strip_tags(addslashes($sound))."',
                comms = '".strip_tags(addslashes($comms))."',
                features = '".strip_tags(addslashes($features))."',
								battery = '".strip_tags(addslashes($battery))."',
								misc	= '".strip_tags(addslashes($misc))."',
                tests = '".strip_tags(addslashes($tests))."',
								stok		= '".$stok."',
								harga		= '".$harga."',
