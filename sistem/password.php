  ...
  <body class="nav-md">
    <div class="container body">
      ...
      <?php 
		...
		if($_SESSION['pengusaha_id'] == 'superadmin'){
			$nama	= ucfirst($_SESSION['pengusaha_username']);
		}else{
			$sql 	= "SELECT * FROM karyawan WHERE id_karyawan = '".$_SESSION['pengusaha_id']."'";
                  ...
                  <div class="x_content">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <?php
						...
						if(trim($_SESSION['pengusaha_password']) != trim($inppasslama)){
							...
							if (trim($inppass) != trim($inppass2)) {
								...
								$sql 	= "UPDATE login SET password = '".md5($inppass)."' WHERE id_user='".$_SESSION['pengusaha_id']."'";
					...
					?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" id="id" value="<?php echo $_SESSION['pengusaha_username']?>" readonly>
                        </div>
                      </div>
                      <div class="form-group">
